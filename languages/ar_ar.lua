...
-- IF YOU ARE UNSURE, ASK ON TELEGRAM (t.me/falunt_and_dither),
...
*حالات التعافى الكليه:* %s]]
    ...
    ['donate'] = {
        ['1'] = '<b>مرحبا, %s!</b>\n\nلو تشعر بالكرم, يمكنك التبرع لمشروع mafflebot, بدعمنا بشكل إرادي بأي كمية. سوف تستعمل كلها لتكاليف الخوادم و تعويضاً للوقت و الموارد المستعملة في المشروع. هذا **اختياري**, على كل حال مساهمتك مشكورة و ستظهر اسمك في صفحتنا على كيت هاب\n\nإذا أردت الاستمرار, رابط الدعم المادي<a href="%s"> هنا</a>. شكرا جزيلا لدعمك!'
    },
    ['duckduckgo'] = {
        ['1'] = 'لا أعرف ما هذا :/!'
    },
