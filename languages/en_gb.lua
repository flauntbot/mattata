...
-- this file used to just include en-us. the content of en-us was, strictly speaking, english-compatible...
-- but if we're gonna do that, why bother including scottish?
-- so far the changes are:
-- revert american words (blocklist etc) to their english equivalents, and
-- restore english spelling of words ending in "ise"
...
return {
    ...
    ['antispam'] = {
        ...
        ['14'] = 'Hey, I noticed you\'ve got anti-link enabled and you\'re currently not allowing your users to mention a chat you\'ve just mentioned, if you\'d like to whitelist it, use /allowlink <links>.',
